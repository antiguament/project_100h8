                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="hero_subtitle" id="hero_subtitle" class="form-control" rows="3" required>{{ old('hero_subtitle') }}</textarea>
                                    @error('hero_subtitle')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="hero_image">Seleccionar archivo</label>
                                    </div>
                                    @error('hero_image')
                            ...
                            <div class="card-body" id="features-container">
                                <div class="feature-item mb-3 border p-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="features[0][title]" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Descripción</label>
                                        <textarea name="features[0][description]" class="form-control" rows="2" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Ícono (ej: fas fa-check)</label>
                                        <input type="text" name="features[0][icon]" class="form-control" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="facebook" id="facebook" class="form-control" 
                                               value="{{ old('facebook') }}" placeholder="https://facebook.com/tu-pagina">
                                    </div>
                                    @error('facebook')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="instagram" id="instagram" class="form-control" 
                                               value="{{ old('instagram') }}" placeholder="https://instagram.com/tu-cuenta">
                                    </div>
                                    @error('instagram')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="url" name="whatsapp_link" id="whatsapp_link" class="form-control" 
                                               value="{{ old('whatsapp_link') }}" required 
...
<script>
    $(document).ready(function() {
        ...
        // Add new feature
        let featureIndex = 1; // Start from 1 because we have one by default
        ...
        $(document).on('click', '.remove-feature', function() {
            if ($('.feature-item').length > 1) { // Ensure at least one feature remains
